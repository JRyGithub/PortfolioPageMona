...
function InformationSection( {setRoute}) {
    return (
        <article className="cf">
            ...
            <div className="fr w-25 bg-light-gray tc vh-100">
                <div className="fr pa2 pa4-ns bg-white black-70 measure-narrow f2 times vh-100">
                    <header className="bb b--black-70 pv1">
                    ...
                    <section className="pt1 pb3">
                        ...
                        <div className="imagesDiv">
                            ...
                            <a className="link hover-pink near-black dib h2 w2 mr3" href="https://medium.com/@Mona_Harnett" title="Medium">
